...
public final class LoginMockFactory {
    ...
    public ConfigurationService getConfigurationServiceMock() {
        ...
        EasyMock.expect(configuration.getAbsolutePath(BUNDLE_SYMBOLIC_NAME, LoginTestConstants.USER_1_CERTIFICATE_FILENAME))
            .andReturn(LoginTestConstants.USER_1_CERTIFICATE_FILENAME).anyTimes();
        EasyMock.expect(configuration.getAbsolutePath(BUNDLE_SYMBOLIC_NAME, LoginTestConstants.USER_1_KEY_FILENAME))
