...
public interface DistributedLogReaderService {
     ...
     */
    void addLogListener(SerializableLogListener logListener, PlatformIdentifier platformIdentifier);
     ...
     */
    List<SerializableLogEntry> getLog(PlatformIdentifier platformIdentifier);
     ...
     */
    void removeLogListener(SerializableLogListener logListener, PlatformIdentifier platformIdentifier);
}
