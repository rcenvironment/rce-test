...
package de.rcenvironment.rce.configuration.discovery;
...
import de.rcenvironment.rce.configuration.discovery.bootstrap.DiscoveryClientSetup;
import de.rcenvironment.rce.configuration.discovery.bootstrap.DiscoveryClientSetup.ServerEntry;
import de.rcenvironment.rce.configuration.discovery.bootstrap.DiscoveryConfiguration;
import de.rcenvironment.rce.configuration.discovery.bootstrap.DiscoveryServerSetup;
import de.rcenvironment.rce.configuration.discovery.client.DiscoveryClientService;
import de.rcenvironment.rce.configuration.discovery.internal.DiscoveryBootstrapServiceImpl;
import de.rcenvironment.rce.configuration.discovery.internal.DiscoveryClientServiceImpl;
import de.rcenvironment.rce.configuration.discovery.internal.DiscoveryServerManagementServiceImpl;
import de.rcenvironment.rce.configuration.discovery.internal.RemoteDiscoveryService;
import de.rcenvironment.rce.configuration.discovery.server.DiscoveryServerManagementService;
...
public class DiscoveryServicesTest {
    ...
    public void testRemoteCallFailureWithFallbackProperties() {
        ...
        fallbackProperties.put(DiscoveryBootstrapService.QUOTED_REFLECTED_CLIENT_ADDRESS_PROPERTY, "\"1.2.4.0\"");
        ...
        Map<String, String> properties = bootstrapService.initializeDiscovery(configuration);
        Assert.assertNotNull(properties);
        Assert.assertEquals("Simulated client address does not match fallback value", "\"1.2.4.0\"",
            properties.get(DiscoveryBootstrapService.QUOTED_REFLECTED_CLIENT_ADDRESS_PROPERTY));
        Assert.assertEquals(UNEXPECTED_NUMBER_OF_PROPERTY_ELEMENTS_MESSAGE, 1, properties.size());
    }
