...
public final class XMLAuthorizationMockFactory {
    ...
    static {
        ...
        try {
            File file = TempFileUtils.getDefaultInstance().writeInputStreamToTempFile(stream);
    ...
    public static ConfigurationService getConfigurationService() {
        ...
        EasyMock.expect(configurationMock.getAbsolutePath(BUNDLE_SYMBOLIC_NAME, AUTHORIZATION_XML_FULL_FILENAME))
