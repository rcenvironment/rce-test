...
public class ConfigurationInfoImpl implements ConfigurationInfo {
     ...
     * {@inheritDoc}
     * 
     * @see de.rcenvironment.commons.configuration.ConfigurationInfo#getPropertyNames()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see de.rcenvironment.commons.configuration.ConfigurationInfo#getProperty(java.lang.String)
     */
    @Override
