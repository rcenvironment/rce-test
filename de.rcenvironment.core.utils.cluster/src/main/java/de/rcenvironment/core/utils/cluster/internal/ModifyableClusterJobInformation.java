 ...
 */
public class ModifyableClusterJobInformation implements ClusterJobInformation {
    ...
    private String workflowInformation = NO_VALUE_SET;
    ...
    public void setWorkflowInformation(String workflowInformation) {
