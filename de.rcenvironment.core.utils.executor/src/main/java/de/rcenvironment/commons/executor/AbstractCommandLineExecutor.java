...
public abstract class AbstractCommandLineExecutor implements CommandLineExecutor {
    ...
    /**
     * A default implementation that concatenates the individual commands with "&&" and delegates
     * the resulting string to {@link #start(String)}. IF a different behavior is needed, subclasses
     * should override this method without calling super().
     * 
