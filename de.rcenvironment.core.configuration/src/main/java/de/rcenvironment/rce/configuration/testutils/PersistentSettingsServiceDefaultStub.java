...
public class PersistentSettingsServiceDefaultStub implements PersistentSettingsService {
     ...
     * {@inheritDoc}
     *
     * @see de.rcenvironment.rce.configuration.PersistentSettingsService#saveMapWithStringList(java.util.Map, java.lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see de.rcenvironment.rce.configuration.PersistentSettingsService#saveStringValue(
     ...
     * {@inheritDoc}
     *
     * @see de.rcenvironment.rce.configuration.PersistentSettingsService#readStringValue(java.lang.String, java.lang.String)
     */
    @Override
