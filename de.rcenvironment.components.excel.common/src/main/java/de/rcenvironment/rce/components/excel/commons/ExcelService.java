...
public interface ExcelService {
     ...
     */
    void setValues(final File xlFile, final ExcelAddress addr, final Table values) throws ExcelException;
     ...
     */
    void setValues(final File xlFile, final File newFile, final ExcelAddress addr, final Table values) throws ExcelException;
     ...
     * @throws ExcelException thrown if exception occurs during runtime
     */
    Table getValueOfCells(final File xlFile, final ExcelAddress addr) throws ExcelException;
