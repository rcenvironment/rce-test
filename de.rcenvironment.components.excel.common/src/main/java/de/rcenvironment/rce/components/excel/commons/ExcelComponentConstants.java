...
public final class ExcelComponentConstants {
    ...
    public static final String COMPONENT_ID = "de.rcenvironment.rce.components.excel.ExcelComponent_" + COMPONENT_NAME;
    ...
    /** Default datatype for auto discovery. */
    public static final String DEFAULT_DATATYPE = VariantArray.class.getName();
