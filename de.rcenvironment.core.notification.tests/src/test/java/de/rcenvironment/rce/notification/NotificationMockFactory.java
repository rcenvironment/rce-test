...
import de.rcenvironment.rce.notification.internal.NotificationServiceImpl;
...
public final class NotificationMockFactory {
    ...
    private void createPlatformServiceMock() {
        ...
        EasyMock.expect(platformServiceMock.getPlatformIdentifier()).andReturn(NotificationTestConstants.LOCALHOST).anyTimes();

        EasyMock.expect(platformServiceMock.isLocalPlatform(NotificationTestConstants.LOCALHOST)).andReturn(true).anyTimes();
        EasyMock.expect(platformServiceMock.isLocalPlatform(NotificationTestConstants.REMOTEHOST)).andReturn(false).anyTimes();
