...
/**
 * Test cases for the class <code>AuthorizationStoreException</code>.
 * 
 * @author Doreen Seider
 */
public class AuthorizationStoreExceptionTest extends TestCase {
     ...
     */
    private AuthorizationStoreException myException = null;
    ...
    protected void setUp() throws Exception {
        ...
        myException = new AuthorizationStoreException(EXCEPTION_MESSAGE, myCause);
    }
    ...
    public final void testConstructorsForSuccess() {
        myException = new AuthorizationStoreException(EXCEPTION_MESSAGE);
        myException = new AuthorizationStoreException(myCause);
    }
