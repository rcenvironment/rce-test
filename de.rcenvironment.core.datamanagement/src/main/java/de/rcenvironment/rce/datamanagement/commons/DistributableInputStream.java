...
import de.rcenvironment.rce.communication.file.RemoteInputStream;
...
public class DistributableInputStream extends InputStream implements Serializable {
    ...
    public DistributableInputStream(User user, DataReference dataRef, Integer revisionNo, InputStream inputStream) {
        this.cert = user;
        this.inputStream = inputStream;
        try {
            PlatformIdentifier platformIdentifier = dataRef.getPlatformIdentifier();
            this.uriToInputStream = new URI("rce://" + platformIdentifier.getNodeId() + "/"
                    + dataRef.getIdentifier() + "/" + revisionNo);
