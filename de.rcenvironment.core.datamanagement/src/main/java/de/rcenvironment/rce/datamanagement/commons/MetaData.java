...
public final class MetaData implements Cloneable, Serializable {
    ...
    /**
     * User who has initial created the {@link DataReference}. Read-only data. This is a revision
    ...
    private final boolean isRevisionIndependent;
    ...
    public MetaData(String key, boolean isRevisionIndependent, boolean isReadOnly) {
        ...
        this.key = key;
        this.isRevisionIndependent = isRevisionIndependent;
        this.isReadOnly = isReadOnly;
    }

    /**
     * @return <code>true</code> if this {@link MetaData} is revision independent.
     */
    public boolean isRevisionIndependent() {
        return isRevisionIndependent;
    }
     ...
     * @param key
     *            Key to use.
     * @param isRevisionIndependent
     *            True creates a revision independent MetaData.
    ...
    public boolean equals(Object obj) {
        ...
        if (isRevisionIndependent != other.isRevisionIndependent) {
            return false;
        }
        if (key == null) {
            if (other.key != null) {
