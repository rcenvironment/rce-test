 ...
 * 
 * The design rationale is that (a) only successful connections should trigger an id generation, (b)
 * transports provide their own connection implementations, and (c) transports should be able to
 * make connection objects immutable. This is best achieved by passing an id factory to the
 * transport implementations.
 * 
 * @author Robert Mischke
 */
public interface NetworkConnectionIdFactory {
