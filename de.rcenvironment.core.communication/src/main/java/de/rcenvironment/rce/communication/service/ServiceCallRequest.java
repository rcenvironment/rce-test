...
public class ServiceCallRequest implements Serializable {
    ...
    /**
     * The {@link PlatformIdentifier} where the bundle's class/method/package to call is located.
     */
    private final PlatformIdentifier piRequested;

    /**
     * The {@link PlatformIdentifier} of the calling platform.
     */
    private final PlatformIdentifier piCalling;
     ...
     * 
     * @param piRequested The name of the {@link PlatformIdentifier}.
     * @param piCalling The name of the {@link PlatformIdentifier}.
     ...
     */
    public ServiceCallRequest(PlatformIdentifier piRequested, PlatformIdentifier piCalling,
    ...
    public PlatformIdentifier getRequestedPlatform() {
        return piRequested;
    }

    public PlatformIdentifier getCallingPlatform() {
        return piCalling;
    }
