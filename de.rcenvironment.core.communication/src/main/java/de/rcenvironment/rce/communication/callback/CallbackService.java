...
public interface CallbackService {
     ...
     * @param platformIdentifier The {@link PlatformIdentifier} of the remote platform doing the
     *        call backs.
     * @return the object's identifier used for callback() and setTimeToLive().
     */
    String addCallbackObject(Object callBackObject, PlatformIdentifier platformIdentifier);
     ...
     * @param proxyHome The {@link PlatformIdentifier} of the remote platform where the proxy will
     *        be located then.
     * @return The created proxy object.
     */
    Object createCallbackProxy(CallbackObject callbackObject, final String objectIdentifier, PlatformIdentifier proxyHome);
}
