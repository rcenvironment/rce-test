...
public final class CallbackUtils {
     ...
     * @param pi The {@link PlatformIdentifier} of the remote platform.
     * @param cs The {@link CallbackService} to use.
     * @return the proxied object or <code>o</code> if there is no need for proxying.
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static Object handleCallbackObject(Object o, PlatformIdentifier pi, CallbackService cs) {
