...
public class DistributedLogReaderServiceImplTest {
    ...
    private final PlatformIdentifier piNotReachable = PlatformIdentifierFactory.fromHostAndNumberString("notReachable:1");
    ...
    private class DummyCommunicationService extends MockCommunicationService {
        ...
        public Object getService(Class<?> iface, PlatformIdentifier platformIdentifier, BundleContext bundleContext)
            ...
            Object service = null;
            if (iface == SerializableLogReaderService.class && piLocal.equals(platformIdentifier) && bundleContext == context) {
                service = new DummyLocalSerializableLogReaderService();
            } else if (iface == SerializableLogReaderService.class && piRemote.equals(platformIdentifier) && bundleContext == context) {
                service = new DummyRemoteSerializableLogReaderService();
            } else if (iface == SerializableLogReaderService.class && piNotReachable.equals(platformIdentifier)
