...
public class BackendSupportTest {
    ...
    private CatalogBackend catalogBackend = EasyMock.createNiceMock(CatalogBackend.class);
    ...
    public void testGetCatalogBackend() {
        assertEquals(catalogBackend, BackendSupport.getCatalogBackend());
    }
    ...
    public void testGetDataBackend() {
        ...
        assertEquals(dataBackend, BackendSupport.getDataBackend(DataReferenceType.fileObject));
    }
    ...
    private class DummyConfigurationService extends MockConfigurationService.ThrowExceptionByDefault {
        ...
        public <T> T getConfiguration(String identifier, Class<T> clazz) {
            ...
            config.setCatalogBackend(catalogBackendProvider);
    ...
    /**
     * Helper method creating a {@link BundleContext} object which retrieves the given backend
     * services.
     * 
     * @param catalogBackend
     *            {@link CatalogBackend} to retrieve.
     * @param dataBackend
     *            {@link DataBackend} to retrieve.
     * @return the {@link BundleContext}.
     */
    public static BundleContext createBundleContext(CatalogBackend catalogBackend, DataBackend dataBackend) {
        ...
        // catalog backend
        String catalogFilterString = OPEN_BRACKET + CatalogBackend.PROVIDER + EQUALS_SIGN + catalogBackendProvider + CLOSE_BRACKET;
        ...
        try {
            EasyMock.expect(bundleContext.getServiceReferences(CatalogBackend.class.getName(), catalogFilterString))
        ...
        // for failures
        EasyMock.expect(bundleContext.getServiceReference(null)).andReturn(null).anyTimes();
