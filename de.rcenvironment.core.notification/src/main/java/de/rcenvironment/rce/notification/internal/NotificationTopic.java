...
public class NotificationTopic {
     ...
     */
    protected void add(NotificationSubscriber subscriber) {
     ...
     */
    protected void remove(NotificationSubscriber subscriber) {
     ...
     */
    protected Set<NotificationSubscriber> getSubscribers() {
