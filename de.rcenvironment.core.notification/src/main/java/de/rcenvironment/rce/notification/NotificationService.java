...
public interface NotificationService {
    ...
    /** Notification body used for sending notifications about the deregistration of publishers. */
    String PUBLISHER_DEREGISTERED = "The publisher no longer publishes notifications."
        + "As a result of this action, your role as a subscriber has been revoked.";
     ...
     */
    void addPublisher(String notificationId, NotificationPublisher publisher);
     ...
     *        trigger.
     */
    void trigger(String notificationId);
