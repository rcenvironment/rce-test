...
public interface DistributedNotificationService {
     ...
     * @param publisherPlatform The {@link PlatformIdentifier} of the corresponding publisher.
     ...
     */
    Map<String, Long> subscribe(String notificationId, NotificationSubscriber subscriber, PlatformIdentifier publisherPlatform);
     ...
     *        <code>null</code> if local.
     */
    void unsubscribe(String notificationId, NotificationSubscriber subscriber, PlatformIdentifier publishPlatform);
     ...
     */
    Map<String, SortedSet<NotificationHeader>>  getNotificationHeaders(String notificationId, PlatformIdentifier publishPlatform);

    /**
     * Returns all stored {@link Notification}s represented by the given notification identifier.
     * 
     * @param notificationId The notification identifier which represents the
     *        {@link Notification} to get.
     * @param publishPlatform The {@link PlatformIdentifier} of the corresponding publisher.
     *        <code>null</code> if local.
     * @return the {@link Notification}s sorted by the matching notification identifier.
     */
    Map<String, List<Notification>> getNotifications(String notificationId, PlatformIdentifier publishPlatform);
     ...
     *        <code>null</code> if local.
     */
    void trigger(String notificationId, PlatformIdentifier publishPlatform);
}
