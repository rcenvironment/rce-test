...
public class NotificationHeader implements Comparable<NotificationHeader>, Serializable {
    ...
    private PlatformIdentifier publishPlatform = null;
     ...
     */
    public NotificationHeader(String notificationIdentifier, long edition, PlatformIdentifier publisherPlatform) {
        timestamp = new Date();
     ...
     * @return the platform.
     */
    public PlatformIdentifier getPublishPlatform() {
