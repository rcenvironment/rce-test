...
public class PipedPropertyChangeListener implements PropertyChangeListener {
    ...
    public abstract static class AbstractConverter implements Converter {
         ...
         * {@inheritDoc}
         * 
         * @see de.rcenvironment.rce.components.parametricstudy.gui.view.PipedPropertyChangeListener.Converter#convert(java.lang.Object)
         */
        @Override
         ...
         * {@inheritDoc}
         * 
         * @see de.rcenvironment.rce.components.parametricstudy.gui.view.PipedPropertyChangeListener.Converter#invert(java.lang.Object)
         */
        @Override
