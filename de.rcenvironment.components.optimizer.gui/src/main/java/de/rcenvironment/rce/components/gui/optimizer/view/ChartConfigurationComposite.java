...
import de.rcenvironment.gui.commons.configuration.BeanConfigurationDialog;
import de.rcenvironment.gui.commons.configuration.BeanConfigurationSourceAdapter;
...
import de.rcenvironment.rce.components.gui.optimizer.view.OptimizerDatastore.OptimizerResultSetAddListener;
...
public class ChartConfigurationComposite extends Composite implements
    ...
    private static final class RemoveTraceAction extends Action implements
         ...
         * {@inheritDoc}
         * 
         * @see de.rcenvironment.gui.commons.configuration.ConfigurationViewer.VisibilityAction#setVisible(boolean)
         */
        @Override
         ...
         * {@inheritDoc}
         * 
         * @see de.rcenvironment.gui.commons.configuration.ConfigurationViewer.VisibilityAction#isVisible()
         */
        @Override
