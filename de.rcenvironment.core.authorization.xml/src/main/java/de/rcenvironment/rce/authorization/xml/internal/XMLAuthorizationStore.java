...
package de.rcenvironment.rce.authorization.xml.internal;
...
import de.rcenvironment.commons.xml.XMLIOSupport;
import de.rcenvironment.commons.xml.XMLSupport;
import de.rcenvironment.rce.authorization.AuthorizationStore;
import de.rcenvironment.rce.authorization.AuthorizationStoreException;
...
public class XMLAuthorizationStore implements AuthorizationStore {
    ...
    protected void activate(BundleContext context) {
        ...
        myConfiguration = configurationService.getConfiguration(context.getBundle().getSymbolicName(), XMLAuthorizationConfiguration.class);
    }
    ...
    public void initialize() throws AuthorizationStoreException {
        ...
        try {
            String absPath = configurationService.getAbsolutePath(bundleSymbolicName, myConfiguration.getXmlFile());
    ...
    /**
     * 
     * Returns the description of an {@link RBACObject} from the underlying entry in the XML
     * document.
     * 
    ...
    /**
     * 
     * Returns all permission IDs of the underlying XML document matching the given regular
     * expression.
     * 
