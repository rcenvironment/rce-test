...
import de.rcenvironment.rce.components.parametricstudy.commons.SimpleParametricStudyService;
...
public final class StudyDatastore extends Study {
     ...
     */
    public static StudyDatastore connect(final String identifier, final PlatformIdentifier platform) {
        final SimpleParametricStudyService parametricStudyService = new SimpleParametricStudyService();
