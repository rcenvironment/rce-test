...
import de.rcenvironment.rce.components.excel.commons.SimpleExcelServiceGUIEvents;
...
public class CellSelectionDialog extends Dialog {
    ...
    private ExcelServiceGUIEvents excelEvents = new SimpleExcelServiceGUIEvents();
