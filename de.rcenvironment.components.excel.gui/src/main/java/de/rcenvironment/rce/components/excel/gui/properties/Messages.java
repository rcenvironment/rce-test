...
public class Messages extends NLS {
    ...
    /** Constant. */
    public static String errorNoMetaDataExpandingRelative;
    
    /** Constant. */
    public static String errorNoMetaDataExpandingAbsolute;
    
    /** Constant. */
    public static String errorNoMetaDataPruningRelative;
    
    /** Constant. */
    public static String errorNoMetaDataPruningAbsolute;
