 ...
 */
public class CancelWorkflowHandler extends AbstractWorkflowHandler {
    ...
    public Object execute(final ExecutionEvent event) throws ExecutionException {
        ...
        for (final WorkflowInformation workflowInformation : getWorkflowInformations()) {
            if (workflowInformation != null) {
                workflowRegistry.cancelWorkflow(workflowInformation);
            }
        }
        return null;
    }
    ...
    public boolean isEnabled() {
        ...
        for (final WorkflowInformation workflowInformation : getWorkflowInformations()) {
            ...
            if (workflowState == WorkflowState.PREPARING
                ...
                || workflowState == WorkflowState.PAUSING
