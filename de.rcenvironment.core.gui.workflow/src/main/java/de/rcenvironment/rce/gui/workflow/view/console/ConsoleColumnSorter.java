...
public class ConsoleColumnSorter extends ViewerSorter {
    ...
    public int compare(Viewer viewer, Object object1, Object object2) {
        ...
        if (object1 instanceof ConsoleRow && object2 instanceof ConsoleRow) {
            ...
            // message column
            case 2:
                returnValue = cr1.getText().compareTo(cr2.getText());
                break;

            // component column
            case 3:
                returnValue = cr1.getComponent().compareTo(cr2.getComponent());
                break;
                
            // workflow column
            case 4:
                returnValue = cr1.getWorkflow().compareTo(cr2.getWorkflow());
                break;
