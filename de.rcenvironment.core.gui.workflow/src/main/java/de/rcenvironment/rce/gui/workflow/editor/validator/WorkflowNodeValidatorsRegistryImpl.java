...
public class WorkflowNodeValidatorsRegistryImpl implements WorkflowNodeValidatorsRegistry {
    ...
    public static final String EXTENSION_POINT_ID = "de.rcenvironment.rce.gui.workflow.nodeValidators";
    ...
    private final Map<ComponentFilter, InstanceFactory<? extends WorkflowNodeValidator>> validatorMappings =
        new HashMap<ComponentFilter, InstanceFactory<? extends WorkflowNodeValidator>>();
    ...
    @Override
    public List<WorkflowNodeValidator> getValidatorsForWorkflowNode(final WorkflowNode workflowNode) {
        final List<WorkflowNodeValidator> result = new LinkedList<WorkflowNodeValidator>();
        for (final ComponentFilter filter : validatorMappings.keySet()) {
