 ...
 * @author Sascha Zur
 */
public class AdvancedDynamicEndpointPropertySection extends WorkflowNodePropertySection {

    private static final int SPACE_ON_RIGHT_SIDE = 20;
    
    protected AdvancedDynamicEndpointSelectionPane inputPane;

    protected AdvancedDynamicEndpointSelectionPane outputPane;

    private Composite mainContainer;

    public AdvancedDynamicEndpointPropertySection() {
        ...
        inputPane = new AdvancedDynamicEndpointSelectionPane("Input",
            ComponentDescription.EndpointNature.Input, defaultTypeSelectionFactory, this);
        outputPane = new AdvancedDynamicEndpointSelectionPane("Output",
