...
public final class AuthenticationMockFactory {
    ...
    public static ConfigurationService getConfigurationService() {
        ...
        EasyMock.expect(configurationMock.getAbsolutePath(AuthenticationTestConstants.BUNDLE_SYMBOLIC_NAME, CA))
            .andReturn(CA).anyTimes();
        EasyMock.expect(configurationMock.getAbsolutePath(AuthenticationTestConstants.BUNDLE_SYMBOLIC_NAME, CRL))
